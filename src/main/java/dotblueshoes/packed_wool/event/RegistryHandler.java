...
public class RegistryHandler {
	...
	public static void onItemRegister(RegistryEvent.Register<Item> event) {
		...
		for (int i = 0; i < ModItems.PACKED_WOOL_ITEMBLOCKS.length; i++)
			event.getRegistry().register(ModItems.PACKED_WOOL_ITEMBLOCKS[i].setRegistryName("packed_wool_black_slab").setUnlocalizedName("packed_wool_black_slab"));
	...
	public static void onModelRegister(ModelRegistryEvent event) {
		...
		for (int i = 0; i < ModItems.PACKED_WOOL_BLOCKS.length; i++)
			ModItems.PACKED_WOOL_BLOCKS[i].registerModel();
		for (int i = 0; i < ModItems.PACKED_WOOL_HALF_SLAB_BLOCKS.length; i++)
			ModItems.PACKED_WOOL_HALF_SLAB_BLOCKS[i].registerModel();
		//for (int i = 0; i < ModItems.PACKED_WOOL_DOUBLE_SLAB_BLOCKS.length; i++)
		//	ModItems.PACKED_WOOL_DOUBLE_SLAB_BLOCKS[i].registerModel();
	}
