...
public class LegacyBedRecipeFactory implements IConditionFactory {

	// This is how we tell that theres a condition in json file.
	...
	public BooleanSupplier parse(final JsonContext context, final JsonObject json) {
		return () -> ConfigHandler.isReplaceBedsWithLegacyBed;
	}
